									...
									<div class="panel-body">
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-sm-3 control-label">Kode Inventaris <span class="required">*</span></label>
												<div class="col-sm-9">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label">Petugas <span class="required">*</span></label>
												<div class="col-sm-9">
									...
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-12 col-sm-offset-3">
												...
												<a href="{{ route('andre_inventaris.delete', $andre_inventaris->andre_id_inventaris) }}" class="btn btn-danger">Hapus</a>
											</div>
										</div>
									</footer>
								</section>
