		        ...
		        <div class="col-lg-12">
		        	<div class="panel panel-default">
							...
							<div class="panel-body">
				                ...
				                @endif
								<div class="col-md-6">
									<form role="form" method="POST" action="{{ route('andre_petugas.create') }}">
										@csrf
										<div class="form-group">
											<label>NIP</label>
											<input class="form-control{{ $errors->has('andre_nip') ? ' is-invalid' : '' }}" name="andre_nip" value="{{ old('andre_nip') }}" placeholder="Nama Petugas" required>
										</div>
										<div class="form-group">
								...
								<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input class="form-control{{ $errors->has('andre_password') ? ' is-invalid' : '' }}" name="andre_password" value="{{ old('andre_password') }}" placeholder="Password" required>
										</div>	
										<div class="form-group">
