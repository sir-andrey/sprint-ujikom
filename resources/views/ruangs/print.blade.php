...
<div class="head">
    ...
    <hr />
    <br>
    <p align="center" ><strong> Laporan Data Ruang <br> Inventaris Sarana dan Prasarana SMKN 2 Cimahi</strong></p>
    <table class="styletable">
        ...
        <tbody>
        @foreach($andre_ruang as $key => $data)
            <tr>
                <td>{{ $key+1 }}</td>
                <td>{{ $data->andre_kode_ruang }}</td>
                <td>{{ $data->andre_nama_ruang }}</td>
