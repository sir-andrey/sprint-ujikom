...
<div class="head">
    ...
    <hr />
    <br>
    <p align="center" ><strong>Laporan Data Inventarisir <br>Inventaris Sarana dan Prasarana SMKN 2 Cimahi</strong></p>
    <table class="styletable">
        ...
        <tbody>
        @foreach($andre_inventaris as $key => $data)
            <tr>
                <td>{{ $key+1 }}</td>
                <td>{{ $data->andre_kode_inventaris }}</td>
                <td>{{ $data->andre_nama }}</td>
                <td>{{ $data->jenis->andre_nama_jenis }}</td>
                <td>{{ $data->ruang->andre_nama_ruang }}</td>
                <td>{{ $data->andre_kondisi }}</td>
                <td>{{ $data->andre_jumlah }}</td>
                <td>{{ $data->andre_tanggal_register }}</td>
